...
from .views_quiz import mcq_index, mcq_landing, study, practice, stats, topic_selection, manage_topics
...
app_name = 'mcq'
urlpatterns = [
    path("", mcq_index, name="landing"),
    path("dashboard/", mcq_landing, name="dashboard"),  # Keep dashboard as authenticated route
